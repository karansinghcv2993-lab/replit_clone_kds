...
(function () {
  ...
  ══════════════════════════════════════════════════════════ */
  var STEPS = [
    { number: 1, title: 'Share Your Requirements',    description: 'Tell us about your business, ERP environment, and the processes you want to automate.',                                                                             image: 'assets/images/demo-step-1.png', alt: 'A form on screen for entering personal information — step 1 of the KDS ERP Crew demo booking' },
    { number: 2, title: 'Schedule Your Demo',         description: 'Choose a convenient date and time for a personalized live demonstration with our ERP experts.',                                                                          image: 'assets/images/demo-step-2.png', alt: 'KDS ERP Crew operations dashboard showing AI-powered analytics and metrics' },
    { number: 3, title: 'Experience KDS ERP Crew',   description: 'See AI-powered agents automate transactions, approvals, reporting, and business workflows in real time.',                                                               image: 'assets/images/demo-step-3.png', alt: 'KDS ERP Crew live dashboard demonstrating real-time workflow automation' },
    { number: 4, title: 'Launch Your AI Journey',    description: 'Receive a tailored implementation roadmap and discover how KDS ERP Crew can accelerate your enterprise transformation.', image: 'assets/images/demo-step-4.png', alt: 'KDS ERP Crew logo on screen — ready to launch your enterprise AI journey' }
  ];
